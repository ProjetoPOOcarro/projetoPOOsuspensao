...
public class Gráficos {
    ...
    public Scene CriarGráfico1() {
        ...
        eixoY.setLabel("Deslocamento da massa suspensa");
        ...
        // Texto que exibe o valor atual de DADOS
        Text textoPosicaoY = new Text(10, 20, "Posição Y: " + DADOS);
        textoPosicaoY.setFill(Color.BLACK);
        ...
        Timeline timeline = new Timeline(new KeyFrame(Duration.seconds(0.5), e -> {
            ...
            Platform.runLater(() -> {
                ...
                textoPosicaoY.setText("Posição Y: " + DADOS);
            });
        ...
        painel.getChildren().addAll(textoPosicaoY, graficoDeLinha);
